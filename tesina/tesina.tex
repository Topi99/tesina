...
\chapter{Planteamiento del problema}
  ...
  de este trabajo, el objetivo de este capítulo es describir la problemática en
  la optimización de la ubicación de trampas para mosquito. Para esto, este 
  capítulo se hablará sobre problemas y limitaciones con la herramienta actual
