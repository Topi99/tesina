...
\chapter{Solución}
  ...
  \section{Desarrollo de la solución}
    ...
    \subsection{Selección de parámetros}\label{subsect:seleccion-params}
...
\chapter{Metodología de evaluación}
  ...
  \section{Comparación de métodos}
    ...
    búsqueda de mejores parámetros (mencionada en la sub sección
    \ref{subsect:seleccion-params}), para así tener una referencia de con qué
    ...
    argumentos, se le indicó que generara 200 puntos y un radio mínimo de la
    ...
    GA). Los datos de cada ejecución de los algoritmos fueron exportados a
    archivos CSV para después ser analizados y graficados por un programa
    diferente. Este programa se ejecutó múltiples veces para tener variedad en
    los resultados.
    ...
    optimizando las ubicaciones de las trampas a comparación del GA. Además de
    estas métricas, con los archivos CSV exportados por las optimizaciones,
    se puede graficar el desempeño del PSO y GA, para así cotejar el
    comportamiento de búsqueda de cada algoritmo.
...
\chapter{Resultados y contribuciones}
  ...
  \section{Búsqueda de mejores parámetros}\label{sect:busqueda-mejores-params}
    ...
    Así mismo, se seleccionaron 20 y -20 como velocidad máxima
    y mínima. Igualmente, como población se optó por 40 partículas, pues se
