...
\section{Conceptos básicos}
  ...
  \subsection{Particle Swarm Optimization}
    ...
    (PSO-iw)\cite{CPSO,PSOReview}. En esta fora estándar de PSO, se introduce
    una nueva variable $w$,
    modificando \ref{eq:1} a \ref{eq:3}. Esta nueva variable equilibra la
    búsqueda local y global de la solución.
